              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Card className="p-8 hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
                  ...
                  <div className="grid grid-cols-4 gap-4 mb-6">
                    <div className="flex flex-col items-center p-3 rounded-lg bg-muted/50 hover:bg-muted dark:bg-white transition-colors">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-center">
            <img
              ...
              className=" h-90 rounded-lg border-3 p-2 border-green shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer"
